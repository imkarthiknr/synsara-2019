...
var main = function () {
  ...
  var scroll_changes = function () {
    ...
    if ((homeHeight + aboutHeight + 100 + eventGridHeight - topBarHeight) <= winScroll) {
      activeNav.removeClass("nav-active");
      $("a[href$='About']").removeClass("nav-active");
      $("a[href$='Events']").removeClass("nav-active");
      $("a[href$='Register']").addClass("nav-active");
    } else if ((homeHeight + aboutHeight + 100 + eventGridHeight - topBarHeight) > winScroll) {
  ...
  $(".event_column").click(function () {
    ...
    $('html,body').animate({
      scrollTop: $(".home-slide").height() + $(".about-container").height() + $(".event-container").height() + $(".Register").height() + 200 - topBarHeight
    }, 600);
  });
